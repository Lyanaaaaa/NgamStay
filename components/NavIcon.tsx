...
const NavIcon: React.FC<NavIconProps> = ({ type, active = false, onClick }) => {
  const colorClass = active ? 'text-brand-dark dark:text-brand-light' : 'text-gray-300 dark:text-gray-600 hover:text-brand-mid dark:hover:text-brand-light transition-colors';
