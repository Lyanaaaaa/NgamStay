        ...
        <div className="flex-1 lg:p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8 px-4 md:px-0 mt-4 md:mt-0">
            ...
            <div className="hidden md:grid grid-rows-2 gap-3 h-96">
              ...
              {/* View All Button */}
              <div className="bg-brand-dark rounded-2xl flex items-center justify-center text-white font-black text-lg cursor-pointer hover:bg-black transition-colors shadow-lg">
                View All Photos
              </div>
